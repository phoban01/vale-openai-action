            ...
            const code = yield core.group('Running vale with reviewdog 🐶 ...', () => __awaiter(this, void 0, void 0, function* () {
                ...
                const response = yield openai.chat.completions.create({
                    ...
                    messages: [
                        ...
                        {
                            role: 'system',
                            content: 'Your output should be raw jsonlines data with the addition of suggestions for each message in the input data.'
                        },
                        { role: 'user', content: `Here is the file: ${content}` },
                        {
                            role: 'user',
                            content: `Here is the json data: ${JSON.stringify(inputData)}. Please return in jsonlines format.`
                        }
                    ]
                });
                if (!(response.choices &&
