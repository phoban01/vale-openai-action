...
const prompt = 'I am going to give you a markdown file and a json data set. I want you to look at the line field in the json data set and create a suggested fix based on the content. You should return the json data set (in json format) with a suggested fix field added.';
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const code = yield core.group('Running vale with reviewdog 🐶 ...', () => __awaiter(this, void 0, void 0, function* () {
                // Vale output ...
                const output = yield exec.getExecOutput(actionInput.exePath, [actionInput.path], {
                    cwd,
                ...
                const content = yield fs.readFile(actionInput.path);
